...
export const strategySections: NavItem[] = [
  { name: "01 The Organisation", href: "/foundation/organisation" },
  { name: "02 Brand Ecosystem", href: "/foundation/ecosystem" },
  { name: "03 Digital Infrastructure", href: "/foundation/infrastructure" },
  { name: "04 12-Month Calendar", href: "/visibility/calendar" },
  { name: "05 Agentic AI Engine", href: "/growth/agentic-ai" },
  { name: "06 SEO & AI SEO", href: "/visibility/seo" },
  { name: "07 Brand Architecture", href: "/foundation/brand" },
  { name: "08 Executive Visibility", href: "/visibility/leadership" },
  { name: "09 B-BBEE & Skills Levy", href: "/growth/commercial" },
  { name: "10 Community & Alumni", href: "/delivery/community" },
  { name: "11 Content Marketing", href: "/visibility/content" },
  { name: "12 Partnerships & PR", href: "/growth/partnerships" },
  { name: "13 Competitive Position", href: "/growth/positioning" },
  { name: "14 AI in Curriculum", href: "/delivery/curriculum" },
  { name: "15 KPIs & Dashboard", href: "/delivery/kpis" },
  { name: "16 Budget Framework", href: "/delivery/budget" },
  { name: "17 Implementation", href: "/delivery/implementation" },
  { name: "18 Risk & Contingency", href: "/delivery/risk" },
];
...
export const corePillars: Pillar[] = [
  ...
  },
  {
    ...
    subpages: [
      ...
      { name: "Risk & Contingency", href: "/delivery/risk", description: "Risk controls and mitigation plan" },
    ],
  },
];
