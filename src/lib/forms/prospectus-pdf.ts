...
export function createProspectusPdf() {
  const lines = [
    ...
    "It covers the Foundation, Visibility, Growth Engine, Delivery, Smart Tools and SA Film Intense talent portal ecosystem.",
    "",
    ...
    "3. GreenSet, FILMGRO, ACE and SA Film Intense as a coherent brand family.",
