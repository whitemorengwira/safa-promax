...
export const pageData: Record<string, SectionPageData> = {
  ...
  calendar: {
    ...
    events: [
      ...
      },
      {
        ...
        bullets: [
          'Cineterns commercial launch — full pricing model active',
          'The self-sustainability case modelled publicly',
          'All production-company SLAs reviewed and renewed with Cineterns bundling',
  ...
  community: {
    ...
    cards: [
      ...
      },
      {
        ...
        text: 'Digital credential for Cineterns: "SAFA Alumni" badge on every ACE graduate profile. Searchable alumni directory on main website.',
      },
    ],
  },
  ...
  positioning: {
    ...
    tableRows: [
      [
        ...
        'Specialised MICT SETA expertise carried by every interaction; compliance is a revenue-generating asset, not a cost center',
      ],
      [
      ...
      [
        ...
        'Cineterns placement portal; real-time availability; agentic matching; enterprise-grade security and POPIA compliance',
      ],
      [
  ...
  kpis: {
    ...
    tableRows: [
      ['Cineterns Registered Trainees', 80, 320, 'SAFA Operations'],
      ['Cineterns Registered Production Companies', 5, 40, 'SAFA Operations'],
      ['Live Production Placements (monthly)', 6, 24, 'Cineterns Agent'],
  ...
  implementation: {
    ...
    metrics: [
      ...
      },
      {
        ...
        description: 'Cineterns open beta closes with the first confirmed trainee–production company placement logged.',
      },
      {
        num: '3',
        label: 'CONTENT',
      ...
      },
      {
        ...
        suffix: 'Active',
        description: 'Five production companies signed and actively posting roles to Cineterns by end of June.',
      },
    ],
    cards: [
      {
