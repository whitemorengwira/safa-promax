  ...
  return (
    <main className="flex flex-col min-h-screen bg-bg">
      ...
      <PageHero
        ...
        imageSrc="/images/ai/v4/delivery/budget-operating-envelope-hero.webp"
        imageAlt="Film academy finance and production leads reviewing a monthly operating envelope"
      />
      ...
      >
        <TwoColLayout
          ...
          right={
            <ImagePlaceholder
              src="/images/ai/v4/delivery/budget-approval-gate.webp"
