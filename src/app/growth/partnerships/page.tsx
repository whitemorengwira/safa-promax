...
export default function Page() {
  return (
    <main className="flex flex-col min-h-screen bg-bg">
      ...
      <SectionShell
        eyebrow="13.1"
        title="The Broadcast _Core_"
        subtitle="Converting goodwill into institutional reputation."
      >
        <div className="mb-16">
          <SvgStage aspect="wide" label="Broadcast · Signal Topology">
            <svg viewBox="0 0 1200 460" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
              ...
              {/* Concentric radiating signal waves from a central broadcast point */}
              ...
              {/* Partner nodes positioned around the broadcast */}
      ...
      <SectionShell
        eyebrow="13.2"
        title="Media _Relations_"
        subtitle="Earning the headlines through consistent, authoritative storytelling."
      ...
      <section className="section-padding container-max text-center py-24">
        <Reveal>
          <h2 className="mb-8">Ready to explore the _Positioning_ strategy?</h2>
          <Link
